...
class DermAidInferenceEngine(context: Context) {
    ...
    fun preprocessBitmap(bitmap: Bitmap): ByteBuffer {
        ...
        // 1 batch * 224 height * 224 width * 3 channels * 4 bytes for FLOAT32
        ...
        for (i in 0 until 224) {
            for (j in 0 until 224) {
                ...
                // Assuming standard 0.0 - 1.0 normalization for Float32 inputs.
                // You can also change this if it expects -1.0 to 1.0 or imagenet standard normalization.
